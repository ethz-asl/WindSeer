...
def TU25():
    ...
    add_sample_s(data, 'HT', 982, 1703,  8, 10.28)
    add_sample_s(data, 'HT', 982, 1703, 15, 10.12)
    ...
    add_sample_w(data, 'CP', 1287, 1415,  5, 8.94, 0.47, 220, 0.5 * (0.859**2 + 0.612**2 + 0.232**2))
    add_sample_w(data, 'CP', 1287, 1415, 10, 8.79, np.nan, 223)
    add_sample_w(data, 'CP', 1287, 1415, 16, 9.54, 0.42, 217, 0.5 * (0.701**2 + 0.556**2 + 0.375**2))
...
def TU30A():
    ...
    add_sample_upw(data, 'RS', -99, -1062, 10, 7.5,   0.0, 137.8, 0.5 * (1.263**2 + 0.732**2 + 0.3**2)) # sigw filled in
    ...
    add_sample_s(data, 'HT', 982, 1703,  8, 10.80)
    add_sample_s(data, 'HT', 982, 1703, 15, 11.65)
    add_sample_s(data, 'HT', 982, 1703, 24, 12.25)
    add_sample_s(data, 'HT', 982, 1703, 34, 12.23)
    ...
    add_sample_w(data, 'CP', 1287, 1415,  1.6,  8.04, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415,  3.0,  9.23, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415,  5.0,  8.80, 0.71, np.nan, 0.5 * (1.250**2 + 1.414**2 + 0.323**2))
    add_sample_w(data, 'CP', 1287, 1415,  7.4, 10.95, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415, 10.0, 10.39, 0.83, 137, 0.5 * (1.228**2 + 0.85**2 + 0.343**2))
    add_sample_w(data, 'CP', 1287, 1415, 16.0, 11.18, 0.89, 137, 0.5 * (1.174**2 + 0.85**2 + 0.383**2))
...
def TU30B():
    ...
    add_sample_s(data, 'HT', 982, 1703,  8, 15.11)
    add_sample_s(data, 'HT', 982, 1703, 15, 16.61)
    add_sample_s(data, 'HT', 982, 1703, 24, 17.65)
    add_sample_s(data, 'HT', 982, 1703, 34, 17.62)
    add_sample_s(data, 'HT', 982, 1703, 49, 17.74)
    ...
    add_sample_w(data, 'CP', 1287, 1415,  1.6, 12.08, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415,  3.0, 13.75, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415,  5.0, 13.41, 1.12, np.nan, 0.5 * (1.964**2 + 1.237**2 + 0.416**2))
    add_sample_w(data, 'CP', 1287, 1415,  7.4, 16.80, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415, 10.0, 15.10, 1.18, 119, 0.5 * (1.924**2 + 1.292**2 + 0.494**2))
    add_sample_w(data, 'CP', 1287, 1415, 16.0, 16.16, 1.41, 120, 0.5 * (1.868**2 + 1.318**2 + 0.563**2))
...
def TU01A():
    ...
    add_sample_s(data, 'HT', 982, 1703,  8, 16.73)
    add_sample_s(data, 'HT', 982, 1703, 15, 17.19)
    add_sample_s(data, 'HT', 982, 1703, 24, 17.07)
    add_sample_s(data, 'HT', 982, 1703, 49, 16.88)
    ...
    add_sample_w(data, 'CP', 1287, 1415,  1.6, 12.32, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415,  3.0, 13.80, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415,  5.0, 14.12, 1.05, 186, 0.5 * (1.426**2 + 1.023**2 + 0.323**2))
    add_sample_w(data, 'CP', 1287, 1415,  7.4, 16.11, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415, 10.0, 14.96, 1.54, 180, 0.5 * (1.280**2 + 1.036**2 + 0.439**2))
    add_sample_w(data, 'CP', 1287, 1415, 16.0, 15.60, 1.13, 179, 0.5 * (1.217**2 + 1.075**2 + 0.561**2))
...
def TU01B():
    ...
    add_sample_s(data, 'HT', 982, 1703,  8, 15.51)
    add_sample_s(data, 'HT', 982, 1703, 15, 15.79)
    add_sample_s(data, 'HT', 982, 1703, 24, 15.62)
    add_sample_s(data, 'HT', 982, 1703, 49, 15.45)
    ...
    add_sample_w(data, 'CP', 1287, 1415,  1.6, 11.32, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415,  3.0, 12.74, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415,  5.0, 13.11, 0.97, 192, 0.5 * (1.290**2 + 0.964**2 + 0.321**2))
    add_sample_w(data, 'CP', 1287, 1415,  7.4, 14.57, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415, 10.0, 13.81, 1.41, 186, 0.5 * (1.150**2 + 0.985**2 + 0.433**2))
    add_sample_w(data, 'CP', 1287, 1415, 16.0, 14.37, 0.98, 185, 0.5 * (1.090**2 + 0.954**2 + 0.546**2))
...
def TU01C():
    ...
    add_sample_s(data, 'HT', 982, 1703,  8, 14.25)
    add_sample_s(data, 'HT', 982, 1703, 15, 14.43)
    add_sample_s(data, 'HT', 982, 1703, 24, 14.59)
    add_sample_s(data, 'HT', 982, 1703, 49, 14.82)
    ...
    add_sample_w(data, 'CP', 1287, 1415,  1.6, 10.62, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415,  3.0, 11.96, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415,  5.0, 12.14, 0.86, 197, 0.5 * (1.182**2 + 0.741**2 + 0.280**2))
    add_sample_w(data, 'CP', 1287, 1415,  7.4, 13.80, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415, 10.0, 12.80, 1.26, 192, 0.5 * (1.071**2 + 0.759**2 + 0.380**2))
    add_sample_w(data, 'CP', 1287, 1415, 16.0, 13.40, 0.85, 191, 0.5 * (1.049**2 + 0.701**2 + 0.470**2))
...
def TU01D():
    ...
    add_sample_s(data, 'HT', 982, 1703,  5, 14.34)
    add_sample_s(data, 'HT', 982, 1703,  8, 14.31)
    add_sample_s(data, 'HT', 982, 1703, 15, 14.30)
    add_sample_s(data, 'HT', 982, 1703, 24, 14.46)
    add_sample_s(data, 'HT', 982, 1703, 34, 14.37)
    add_sample_s(data, 'HT', 982, 1703, 49, 14.67)
    ...
    add_sample_w(data, 'CP', 1287, 1415,  1.6, 10.85, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415,  3.0, 11.89, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415,  5.0, 12.02, 0.82, 211, 0.5 * (1.602**2 + 0.890**2 + 0.295**2))
    add_sample_w(data, 'CP', 1287, 1415,  7.4, 13.63, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415, 10.0, 12.40, 1.16, 207, 0.5 * (1.559**2 + 0.895**2 + 0.458**2))
    add_sample_w(data, 'CP', 1287, 1415, 16.0, 12.90, 0.72, 205, 0.5 * (1.602**2 + 0.853**2 + 0.575**2))
...
def TU03A():
    ...
    add_sample_s(data, 'HT', 982, 1703,  8, 18.01)
    add_sample_s(data, 'HT', 982, 1703, 15, 18.29)
    add_sample_s(data, 'HT', 982, 1703, 24, 17.95)
    add_sample_s(data, 'HT', 982, 1703, 34, 17.54)
    ...
    add_sample_w(data, 'CP', 1287, 1415,  1.6, 14.63, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415,  3.0, 15.80, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415,  5.0, 15.99, 1.08, 217, 0.5 * (1.357**2 + 1.064**2 + 0.363**2))
    add_sample_w(data, 'CP', 1287, 1415,  7.4, 18.17, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415, 10.0, 16.45, 1.49, 213, 0.5 * (1.119**2 + 1.057**2 + 0.557**2))
    add_sample_w(data, 'CP', 1287, 1415, 16.0, 16.92, 0.85, 211, 0.5 * (1.119**2 + 1.007**2 + 0.685**2))
...
def TU03B():
    ...
    add_sample_upw(data, 'HT', 982, 1703, 47, 15.9,  3.0, np.nan, 0.5 * (1.20**2 + 0.88**2 + 0.83**2))
    add_sample_upw(data, 'HT', 982, 1703,  6, 15.8,  1.2, np.nan, 0.5 * (1.41**2 + 1.11**2 + 0.68**2))
    add_sample_upw(data, 'HT', 982, 1703,  4, 16.0, -0.6, np.nan, 0.5 * (1.60**2 + 1.22**2 + 0.65**2))
    add_sample_upw(data, 'HT', 982, 1703,  2, 15.7,  1.2, np.nan, 0.5 * (1.99**2 + 1.35**2 + 0.83**2))
    ...
    add_sample_s(data, 'HT', 982, 1703,  8, 16.30)
    add_sample_s(data, 'HT', 982, 1703, 15, 16.63)
    add_sample_s(data, 'HT', 982, 1703, 24, 16.15)
    add_sample_s(data, 'HT', 982, 1703, 34, 15.77)
    ...
    add_sample_w(data, 'CP', 1287, 1415,  1.6, 13.01, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415,  3.0, 14.27, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415,  5.0, 14.57, 1.00, 217, 0.5 * (1.287**2 + 0.986**2 + 0.330**2))
    add_sample_w(data, 'CP', 1287, 1415,  7.4, 16.35, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415, 10.0, 15.05, 1.37, 213, 0.5 * (1.093**2 + 0.947**2 + 0.483**2))
    add_sample_w(data, 'CP', 1287, 1415, 16.0, 15.49, 0.80, 212, 0.5 * (1.061**2 + 0.901**2 + 0.616**2))
...
def TU05A():
    ...
    add_sample_s(data, 'HT', 982, 1703,  8, 13.70)
    add_sample_s(data, 'HT', 982, 1703, 24, 14.83)
    add_sample_s(data, 'HT', 982, 1703, 34, 14.64)
    ...
    add_sample_w(data, 'CP', 1287, 1415,  1.6, 10.33, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415,  3.0, 11.80, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415,  5.0, 11.56,  0.14, 279, 0.5 * (1.346**2 + 1.036**2 + 0.246**2))
    add_sample_w(data, 'CP', 1287, 1415,  7.4, 13.84, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415, 10.0, 12.78,  0.16, 279, 0.5 * (1.357**2 + 1.133**2 + 0.305**2))
    add_sample_w(data, 'CP', 1287, 1415, 16.0, 13.31, -0.03, 279, 0.5 * (1.318**2 + 1.166**2 + 0.361**2))
...
def TU05B():
    ...
    add_sample_s(data, 'HT', 982, 1703,  8, 11.36)
    add_sample_s(data, 'HT', 982, 1703, 24, 12.78)
    add_sample_s(data, 'HT', 982, 1703, 34, 13.31)
    ...
    add_sample_w(data, 'CP', 1287, 1415,  1.6,  8.33, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415,  3.0,  9.51, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415,  5.0,  9.23, -0.06, 305, 0.5 * (1.182**2 + 0.873**2 + 0.271**2))
    add_sample_w(data, 'CP', 1287, 1415,  7.4, 11.33, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415, 10.0, 10.37, -0.14, 304, 0.5 * (1.211**2 + 0.946**2 + 0.329**2))
    add_sample_w(data, 'CP', 1287, 1415, 16.0, 11.10, -0.15, 305, 0.5 * (1.227**2 + 0.999**2 + 0.380**2))
...
def TU05C():
    ...
    add_sample_w(data, 'CP', 1287, 1415,  1.6,  7.97, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415,  3.0,  9.20, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415,  5.0,  8.94, -0.05, 301, 0.5 * (1.125**2 + 0.787**2 + 0.255**2))
    add_sample_w(data, 'CP', 1287, 1415,  7.4, 10.85, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415, 10.0, 10.07, -0.13, 300, 0.5 * (1.117**2 + 0.802**2 + 0.304**2))
    add_sample_w(data, 'CP', 1287, 1415, 16.0, 10.72, -0.19, 301, 0.5 * (1.113**2 + 0.841**2 + 0.344**2))
...
def TU07B():
    ...
    add_sample_s(data, 'HT', 982, 1703,  8, 15.23)
    add_sample_s(data, 'HT', 982, 1703, 15, 15.37)
    add_sample_s(data, 'HT', 982, 1703, 24, 15.63)
    add_sample_s(data, 'HT', 982, 1703, 34, 15.31)
    add_sample_s(data, 'HT', 982, 1703, 49, 15.21)
    ...
    add_sample_w(data, 'CP', 1287, 1415,  1.6, 11.56, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415,  3.0, 13.52, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415,  5.0, 13.45, 0.56, 250, 0.5 * (1.700**2 + 1.268**2 + 0.295**2))
    add_sample_w(data, 'CP', 1287, 1415,  7.4, 15.14, np.nan, np.nan, np.nan)
    add_sample_w(data, 'CP', 1287, 1415, 10.0, 14.22, 0.77, 249, 0.5 * (1.608**2 + 1.464**2 + 0.390**2))
    add_sample_w(data, 'CP', 1287, 1415, 16.0, 14.55, 0.28, 248, 0.5 * (1.581**2 + 1.491**2 + 0.432**2))
