...
def generate_turbulence_spectral(nx, ny, nz, dx, dy, dz, use_fft=True, check_statistics=False):
    '''
...
# This method requires the control library which is not available on the cluster
