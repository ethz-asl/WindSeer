...
def convert_data(infile, outfile, vlim, nx, ny, nz, klim, d3, boolean_terrain, verbose = False, compress = False):
    '''
...
def main():
    ...
    convert_data(args.infile, args.outfile, args.vlim, args.nx, args.ny, args.nz, args.klim, args.d3, args.boolean_terrain, args.verbose, args.compress)
