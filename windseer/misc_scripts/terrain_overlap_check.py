...
import os
import pyproj
import analysis_utils.extract_cosmo_data as cosmo
from osgeo import gdal
from analysis_utils.get_mapgeo_terrain import get_terrain

parser = argparse.ArgumentParser(description='Plot the cosmo grid in comparison to the height map')
...
parser.add_argument('-b', '--plot_blocking', action='store_true', help='Indicates if plt.show should be blocking')
parser.add_argument('-n_hor', '--n_horizontal', type=int, default=1024, help='Number of vertical cells')
parser.add_argument('-n_ver', '--n_vertical', type=int, default=512, help='Number of vertical cells')
